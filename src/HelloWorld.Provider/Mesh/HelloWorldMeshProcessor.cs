...
{
  public class HelloWorld_Command_MeshProcessor : BaseMeshProcessor
  {
    public HelloWorld_Command_MeshProcessor(ApplicationContext appContext)
        : base(appContext)
    {
    }

    public override Guid GetProviderId() =>
      HelloWorldConstants.ProviderId;
